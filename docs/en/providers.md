...
The no-key Google integration uses an undocumented consumer endpoint and can change without notice. Use a supported keyed provider when a documented service contract is required.
