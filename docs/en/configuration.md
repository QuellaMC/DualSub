...
- Subtitle style: DualSub's own look, or Match Platform for the typography of the site's own subtitles. Font size is a scale over the look's base size, which follows the video's height.
...
- Logging level
- Provider API keys and request-delay tuning
...
- AI Context: Gemini 3.5 Flash; Context Cache: Enabled

For Advanced Users:

- Provider: OpenAI Compatible
- AI Context: OpenAI GPT-5.6 Luna
