      ...
      payload: {
        ...
        timedtexttracks: [
          ...
          },
          {
            ...
            ttDownloadables: {
              webvtt: {
                urls: [{ url: 'https://netflix.com/subtitle/12345/es.vtt' }]
              }
            }
          }
        ]
        ...
        timedtexttracks: [
          {
            ...
            ttDownloadables: {
              webvtt: {
                urls: [{ url: 'https://netflix.com/subtitle/unknown/en.vtt' }]
              }
            }
          }
        ]
...
export class MockResponseBuilder {
  ...
  static buildRuntimeResponse(response = {}) {
    const defaultResponse = { ...ChromeApiFixtures.successfulVttResponse, ...response };
