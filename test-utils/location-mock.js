...
class LocationMock {
    constructor(initialLocation = {}) {
        ...
        this.origin =
            initialLocation.origin || `${this.protocol}//${this.host}`;
                ...
                Object.defineProperty(window.location, prop, {
                    ...
                    set: (value) => {
                        ...
                        if (prop === 'hostname' || prop === 'port') {
                            locationMock.host = locationMock.port
                                ? `${locationMock.hostname}:${locationMock.port}`
                                : locationMock.hostname;
    ...
    try {
        Object.defineProperty(window.location, 'setLocation', {
            value: function (newLocation) {
                Object.keys(newLocation).forEach((key) => {
                    if (
                        propertiesToMock.includes(key) &&
                        newLocation[key] !== undefined
                    ) {
...
export { LocationMock, mockWindowLocation };
