    ...
    describe('startDetection', () => {
        ...
        test('should not start detection if already in progress', () => {
            ...
            expect(mockLogger).toHaveBeenCalledWith(
                'warn',
                '[VideoElementDetector:netflix] Video detection is already in progress.',
                {}
            );
...
describe('DOMManipulator', () => {
    ...
    describe('Constructor', () => {
        test('should initialize with default options', () => {
            ...
            expect(defaultManipulator.options.containerClass).toBe(
                'dualsub-container'
            );
    ...
    describe('createSubtitleContainer', () => {
        ...
        test('should return null for null video element', () => {
            ...
            expect(mockLogger).toHaveBeenCalledWith(
                'error',
                '[DOMManipulator:netflix] Cannot create subtitle container: video element is null.',
                {}
            );
        });
    });
    ...
    describe('injectCSS', () => {
        ...
        test('should not inject duplicate styles', () => {
            ...
            expect(mockLogger).toHaveBeenCalledWith(
                'debug',
                '[DOMManipulator:netflix] CSS has already been injected.',
                { styleId: 'test-styles' }
            );
        });
    });
...
describe('PlayerReadyDetector', () => {
    ...
    describe('waitForPlayerReady', () => {
        ...
        test('should not start detection if already in progress', () => {
            ...
            expect(mockLogger).toHaveBeenCalledWith(
                'warn',
                '[PlayerReadyDetector:netflix] Player ready detection is already in progress.',
                {}
            );
...
describe('Factory Functions', () => {
    test('should create platform video detector', () => {
        ...
        expect(detector.platform).toBe('netflix');
        expect(detector.options.selectors).toEqual(
            PLATFORM_DOM_CONFIGS.netflix.videoSelectors
        );
    ...
    test('should create platform DOM manipulator', () => {
        ...
        expect(manipulator.options.containerClass).toBe(
            'dualsub-disneyplus-container'
        );
